...
$$ = \frac{(-1)^k}{2^k}\sqrt{\frac{\pi}{2}}\frac{(-1)^kk!}{2^k}\alpha_i^{-k-1/2} = \frac{k!}{2^{2k}}\sqrt{\frac{\pi}{2}}\alpha_i^{-k-1/2}$$
$$N_i = \left( |\phi_i(k,m,n)|^2 \right)^{-1/2} = $$ 
$$ = \left(%
	    \frac{k!}{2^{2k}}\sqrt{\frac{\pi}{2}}\alpha_i^{-k-1/2}\cdot %
	    \frac{m!}{2^{2m}}\sqrt{\frac{\pi}{2}}\alpha_i^{-m-1/2}\cdot %
	    \frac{n!}{2^{2n}}\sqrt{\frac{\pi}{2}}\alpha_i^{-n-1/2} %
	    \right)^{-1/2} = $$

$$ = \left( \left( \frac{\pi}{2\alpha_i}\right)^{3/2} \left(\frac{1}{4\alpha_i}\right)^{l}k!m!n! \right)^{-1/2} = \left(\sqrt{ \frac{2\alpha_i}{\pi} } \right)^{3/4}%
															\left(\frac{(4\alpha_i)^l}{k!m!n!}\right)^{1/2}$$
