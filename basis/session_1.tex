...
$$ = -\frac{\pi}{2} N_i^2\frac{\partial}{\partial \alpha_i} \int_0^{\infty} e^{-2\alpha_i r^2} \,dr = %
     -\frac{\pi}{2} N_i^2\frac{\partial}{\partial \alpha_i} \frac{1}{\sqrt{2\alpha_i}}\int_0^{\infty} e^{-( r\sqrt{ 2\alpha_i} )^2} \,dr\sqrt{2\alpha} = $$
